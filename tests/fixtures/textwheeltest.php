...
class TextWheelTest
{
    ...
    public $name; # test's name
    public $author; # test's author
    public $url; # test's homepage
    public $package; # test belongs to package
    public $version; # test version
    public $disabled=false; # true if test is disabled
